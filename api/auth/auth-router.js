...
const { checkUsernameFree, checkPasswordLength, checkBody, checkUsernameExists } = require('./auth-middleware')
...
router.post('/register', checkUsernameFree, checkBody,(req, res, next) => {
